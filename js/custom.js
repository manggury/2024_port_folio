...
function mainVisualTimeline() {
    ...
    const span = document.querySelectorAll('.mainVisal .tit h2 span:nth-child(even)');

}


function portfolioWrapTimeline() {
    const wrap = gsap.utils.toArray(".portfolio .slide_wrap .slide");
    ...
    const wm = gsap.to(wrap, {
        ...
        scrollTrigger: {
            ...
            start: 'top top',
            end: () => '+=' + document.querySelector('.portfolio').offsetWidth * 5,
        }
